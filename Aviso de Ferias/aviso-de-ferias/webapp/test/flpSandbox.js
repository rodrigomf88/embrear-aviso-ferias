		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aviso de Ferias",
									"targetURL": "#brcomembraeravisodeferias-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomembraeravisodeferias-display": {
								"semanticObject": "brcomembraeravisodeferias",
								"action": "display",
								"description": "Aviso de Ferias",
								"title": "Aviso de Ferias",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.embraer.avisodeferias",
									"url": sap.ui.require.toUrl("br/com/embraer/avisodeferias")
								}
							}
						}
					}
