sap.ui.define([
	...
	return BaseController.extend("br.com.embraer.avisodeferias.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "br.com.redesarah.avisoFerias.view.ViewSettingsDialog",
					controller: this
		...
		_showDetail : function (oItem) {
			...
			this.getRouter().navTo("object", {
				key : oItem.getBindingContext().getProperty("key")
			}, bReplace);
		},
